...
class TargetSelector:
    ...
    def _create_target_selection(self, parent):
        ...
        if target.organ_type:
            ...
            if target.organ_type == "Any":
                ...
                organ_label = ttk.Label(organ_frame, text=f"Target: {target.organ_type}")
    ...
    def _create_organ_selection(self, parent):
        ...
        if not available_organs:
            no_organs_label = ttk.Label(parent, text="No available organs to target")
    ...
    def _player_selected(self):
        ...
        self.result_player = next((p for p in self.engine.players if p.name == player_name), None)
