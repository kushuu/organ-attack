...
class PlayerPanel(ttk.Frame):
    ...
    def _create_layout(self):
        ...
        # Organs display
        organs_label = ttk.Label(self, text="Organs:", font=('Arial', 10, 'bold'))
        ...
        if self.is_current:
            hand_label = ttk.Label(self, text="Hand:", font=('Arial', 10, 'bold'))
            ...
            self.card_count_label.grid(row=3, column=0, sticky="w", padx=5, pady=2)
