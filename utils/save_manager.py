    ...
    def _update_save_metadata(self, filename: str, game_data: Dict[str, Any]):
        ...
        try:
            ...
            if "players" in game_data:
                players = [p.get("name", "Unknown") for p in game_data["players"]]
        ...
        try:
            ...
            for field in required_fields:
                if field not in game_data:
                    logger.warning(f"Save data missing required field: {field}")
                    return False
    ...
    def export_save(self, filename: str, export_path: str) -> bool:
        ...
        try:
            ...
            with open(export_file, 'w') as f:
                json.dump(game_data, f, indent=2, default=self._json_serializer)
